	 ...
	 <!--header end-->
      ...
      <section id="main-content">
          <section class="wrapper">
                    ...
                    <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="pro_id" name="pro_id" action="" method="POST">
                                   <div class="form-group">
								   <?php
			$sql=mysql_query("select * from serviceprovider where a_id=$a_id");
			...
			$landmark=$row['s_areaofwork'];
			$desc=$row['s_typeofwork'];
			?>
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
									  <input type="text" class="form-control" id="paddress" name="paddress" value="" placeholder="Enter Address" value="<?php echo $addr;?>"/>
								...
								<div class="form-group">
                                      ...
                                      <div class="col-lg-10">
									  <input type="text" class="form-control" id="pareawork" name="pareawork" value="<?php echo $landmark;?>" placeholder="Enter area of work"/>
