                    ...
                    <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="b_id" name="b_id" action="save_brand.php" method="POST">
                                   <div class="form-group">
								   <div  class="col-lg-2 col-sm-2 control-label">Brand Name  </div>
                                      <div class="col-lg-10">
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
									  <textarea class="form-control" id="bdesc" name="bdesc" value="" placeholder="Description"></textarea>
