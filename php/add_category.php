                    ...
                    <div class="col-lg-6">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" id="cat_id" name="cat_id" action="save_category.php" method="POST">
                                   <div class="form-group">
								   <div  class="col-lg-2 col-sm-2 control-label">Category Name  </div>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="cname" id="cname" placeholder="Add Catagory Name">
                                      </div>
                                  </div>
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
									  <textarea class="form-control" id="cdesc" name="cdesc" value="" placeholder="Description"></textarea>
